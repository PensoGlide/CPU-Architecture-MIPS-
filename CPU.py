...
class UltraSuperCalculator:
  ...
  def __init__(self, name):
    ...
    self.user_display = '';
    self.update_display("Buenos Dias!");
  ...
  def divide(self, address_num1, address_num2):
    ...
    if num2 != 0:
      ...
      print("Division by 0 error: {num1}/{num2}.")
    return calculated_value;
...
calc = UltraSuperCalculator("calc")
...
calc.binary_reader("00000100000000000000000001000000") # store 1
calc.binary_reader("00000100000000000000000001000000") # store 1
calc.binary_reader("00000000011001000000000000100000") # add 1 + 1

print(calc.load_value_from_register("00001"))
print(calc.load_value_from_register("00100"))